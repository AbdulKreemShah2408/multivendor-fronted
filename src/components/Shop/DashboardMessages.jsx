...
const DashboardMessages = () => {
  ...
  // FIX 2: Using useRef for socket to keep it stable
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <div className={`w-[12px] h-[12px] rounded-full absolute top-[2px] right-[2px] ${online ? "bg-green-400" : "bg-[#c7b9b9]"}`} />
      </div>
      <div className="pl-3">
