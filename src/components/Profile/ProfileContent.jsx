          ...
          <div className="flex justify-center w-full">
            <div className="relative w-[150px] h-[150px]">
              <img
                src={user?.avatar?.url}
                alt="Profile"
                className="w-full h-full rounded-full object-cover border-4 border-green-500 hover:scale-105 transition-transform"
              />
              <div
                className="w-8 h-8 bg-[#E3E9EE] rounded-full flex items-center justify-center cursor-pointer absolute bottom-1 right-1
...
const Address = () => {
  ...
  return (
    <div className="w-full px-5">
      {open && (
        <div className="fixed w-full h-screen bg-[#000000ba] top-0 left-0 flex items-center justify-center  ">
