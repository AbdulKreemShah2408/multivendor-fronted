...
const AllCoupouns = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    await axios.post(`${server}/coupon/create-coupon-code`,{
      ...
      toast.success("Coupon code is created successfully!");
      setOpen(false);
      window.location.reload();
    }).catch((error)=>{
            ...
            <div className="fixed top-0 left-0 w-full h-screen bg-[#00000062] z-[2000] flex items-center justify-center">
              <div className="w-[90%] 800px:w-[40%] h-[80vh] bg-white rounded-md shadow p-4 overflow-y-scroll ">
                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <br />
                  <div>
                    <label className="pb-2">Min Ammount</label>
                    <input
                      type="number"
                      name="minAmount"
                      value={minAmount}
                  ...
                  <br />
                  <div>
                    <label className="pb-2">Max Ammount</label>
                    <input
                      type="number"
                      name="maxAmount"
                      value={maxAmount}
                  ...
                  <div>
                    ...
                    >
                      <option value="Chooze your selected products">Chooze a selected product</option>
                      {products &&
                        products.map((i) => (
